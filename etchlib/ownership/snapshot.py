...
def validate_snapshot(repository, selections, registry, facts=None, fact_links=(), elevated_actions=()):
    ...
    for module in repository.modules:
        ...
        if len(selection.actions) != len(actions):
            raise OwnershipError("{}: incorrect action selection count".format(module.name))

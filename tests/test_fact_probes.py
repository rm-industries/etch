...
class ProbeTests(unittest.TestCase):
    ...
    def gather(self, name, config):
        return gather_fact(self.registry.fact(name), config, self.context)

    def test_commands_are_inspected_not_executed(self):
    ...
    def test_environment_distinguishes_empty_from_absent(self):
    ...
    def test_file_directory_missing_and_broken_symlink(self):
    ...
    def test_permission_errors_are_not_absence(self):

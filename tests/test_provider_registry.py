...
class RegistryTests(unittest.TestCase):
    ...
    def test_registration_preserves_order_and_origin(self):
    ...
    def test_core_cannot_be_shadowed_and_failure_is_atomic(self):
    ...
    def test_duplicates_within_bundle_and_across_kinds(self):
    ...
    def test_missing_or_wrong_kind(self):
    ...
    def test_registration_never_invokes_lifecycle(self):
        action = MemoryAction()
        self.registry.register(self.plugin, [action])
